          ...
          <form id="msform">
            ...
            <fieldset class="bg-dark  ">
              <div class="form-card bg-dark">
                ...
                <label class="fieldlabels">Imię: *</label>
                <input type="text" name="name" placeholder="Imię" />
                <label class="fieldlabels">Nazwisko: *</label>
                <input type="text" name="surname" placeholder="Nazwisko" />
                <label class="fieldlabels">Data pogrzebu: *</label>
                <input type="date" name="funeral_date" placeholder="Data pogrzebu" />
                <label class="fieldlabels">Miejsce pogrzebu: *</label>
                <input type="text" name="funeral_place" placeholder="Miejsce pogrzebu" />
              </div>
            ...
            <fieldset class="bg-dark  ">
              <div class="form-card bg-dark">
                ...
                <label class="fieldlabels">Ile żył: </label>
                <input type="text" name="age" placeholder="Zawód" />
            ...
            <fieldset class="bg-dark  ">
              <div class="form-card bg-dark">
                ...
                <input type="file" name="funeral_image" id="funeral_image" accept="image/*">
              </div>
